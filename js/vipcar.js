...
form.addEventListener("submit", function (e) {
  ...
  const pnumberSelect = document.getElementById("pnumber");
  ...
  // تحقق بسيط
  if (!name || !phone || !service || !pnumber || !bnumberSelect) {
...
document
  .querySelector(".selectcar-container")
  .addEventListener("click", function (e) {
    const button = e.target.closest(".selectecar-btn");
    if (!button) return;
